    ...
    <div className="min-h-screen bg-dark-900">
      ...
      <section className="hero-gradient relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up">
              <Link
                to="/movies"
                className="bg-primary-600 hover:bg-primary-700 text-white px-8 py-4 rounded-lg text-lg font-semibold btn-hover"
              >
                Browse Movies
              </Link>
              <Link
                to="/schedule"
                className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-dark-900 px-8 py-4 rounded-lg text-lg font-semibold btn-hover"
              >
                View Schedule
              </Link>
            </div>
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
          <div className="absolute top-10 left-10 w-20 h-20 bg-primary-500 rounded-full opacity-20 animate-pulse-slow"></div>
          <div className="absolute top-40 right-20 w-32 h-32 bg-primary-400 rounded-full opacity-10 animate-pulse-slow"></div>
          <div className="absolute bottom-20 left-1/4 w-16 h-16 bg-primary-600 rounded-full opacity-15 animate-pulse-slow"></div>
        </div>
      </section>
